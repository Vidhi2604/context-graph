      ...
      {planLevel === "full" && insight.context ? (
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            <h4 className="text-xs font-semibold text-emerald-400 uppercase">Context</h4>
          ...
          {/* Reasoning */}
          <div className="space-y-2">
            <h4 className="text-xs font-semibold text-blue-400 uppercase">Reasoning</h4>
            {insight.reasoning.map((step) => (
              <div key={step.step} className="bg-gray-950 rounded-lg p-2">
          ...
          {/* Result */}
          <div className="space-y-2">
            <h4 className="text-xs font-semibold text-purple-400 uppercase">Result</h4>
            ...
            {insight.result.impact && (
              <p className="text-[10px] text-emerald-400 mt-1">{insight.result.impact}</p>
            )}
          </div>
        </div>
      ) : (
        ...
        <div className="space-y-3">
          <p className="text-sm text-white">{insight.result.finding}</p>
